...
Additional information and examples:
- [Submission API documentation on GitHub](https://github.com/nemoarchive/documentation/blob/master/submission-api.md)
- [Submission API Swagger documentation](https://app.swaggerhub.com/apis/UMIGS/NeMO_submissions/)
...
- [File Status API documentation on GitHub](https://github.com/nemoarchive/documentation/blob/master/file-status-api.md)
- [File Status API Swagger documentation](https://app.swaggerhub.com/apis-docs/UMIGS/NeMO_file_status/)
