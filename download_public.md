...
| --- | --- |
| Access a specific dataset from a publication | [Collection landing pages](https://nemoarchive.org/resources/data-download#data-collection-landing-pages)  |
| Access a specific data collection found in the BICCN Data Inventory | [Collection landing pages](https://nemoarchive.org/resources/data-download#data-collection-landing-pages) |
| Browse to explore the types of data available across the project | [HTTP Browser](https://nemoarchive.org/resources/data-download#http-directory-structure-browser)  |
| Download an entire NeMO release by date | [HTTP Browser](https://nemoarchive.org/resources/data-download#http-directory-structure-browser) |
| Download all data associated with a particular grant | [HTTP Browser](https://nemoarchive.org/resources/data-download#http-directory-structure-browser) or [Data Portal](https://nemoarchive.org/resources/data-download#nemo-data-portal) |
| Download all data generated by a particular lab | [HTTP Browser](https://nemoarchive.org/resources/data-download#http-directory-structure-browser) or [Data Portal](https://nemoarchive.org/resources/data-download#nemo-data-portal) |
| Download all data associated with a particular technique | [Data Portal](https://nemoarchive.org/resources/data-download#nemo-data-portal) |
| Download all data from a specific species (mouse, marmoset, macaque) | [Data Portal](https://nemoarchive.org/resources/data-download#nemo-data-portal) |
| Download all counts data | [Data Portal](https://nemoarchive.org/resources/data-download#nemo-data-portal) |
| Download all data from a particular anatomical site | [Data Portal](https://nemoarchive.org/resources/data-download#nemo-data-portal) |
| Pull data into NeMO Analytics, Terra, Metaviz and other tools to run custom pipelines | [Data Portal](https://nemoarchive.org/resources/data-download#nemo-data-portal) |
...
An HTTP server-based browser is available at [data.nemoarchive.org](https://data.nemoarchive.org/) for navigation through the NeMO Archive public data directory structure.
